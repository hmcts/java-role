...
properties(
  [[$class: 'GithubProjectProperty', projectUrlStr: 'http://github.com/hmcts/java-role/'],
...
node {
  ws('java-role') { // This must be the name of the role otherwise ansible won't find the role
    try {
